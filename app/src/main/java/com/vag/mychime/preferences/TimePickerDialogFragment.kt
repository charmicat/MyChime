...
class TimePickerDialogFragment : PreferenceDialogFragmentCompat(), TimePickerDialog.OnTimeSetListener {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        picker = TimePickerDialog(activity, this, hour, minute, DateFormat.is24HourFormat(activity))
